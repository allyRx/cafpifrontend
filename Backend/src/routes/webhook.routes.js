...
const EXTERNAL_ENDPOINT = 'http://193.168.147.110:5678/webhook/cafpi-document-analysis';
...
router.post('/cafpi-document-analysis', protect, async (req, res) => {
  ...
  console.log(dossier_number, borrower_name, document_base64, filename, comments);
  ...
  console.log('Response from external webhook:', analysisData);
